...
func NewLocsPanel(ctx context.Context, log zerolog.Logger, apic api.NetworkControlServiceClient) (fyne.CanvasObject, []widget.ToolbarItem) {
	p := &locsPanel{
...
func (p *locsPanel) run(ctx context.Context, log zerolog.Logger, apic api.NetworkControlServiceClient) {
...
func (p *locsPanel) runOnce(ctx context.Context, log zerolog.Logger, apic api.NetworkControlServiceClient) error {
