...
func NewPowerPanel(ctx context.Context, log zerolog.Logger, apic api.CommandStationServiceClient) (fyne.CanvasObject, []widget.ToolbarItem) {
	p := &powerPanel{
...
func (p *powerPanel) run(ctx context.Context, log zerolog.Logger, apic api.CommandStationServiceClient) {
...
func (p *powerPanel) runOnce(ctx context.Context, log zerolog.Logger, apic api.CommandStationServiceClient) error {
